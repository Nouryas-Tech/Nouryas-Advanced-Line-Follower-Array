...
Line Color ====> Black = 0 , White = 1 >>>>> in this example 0 for Black line
A_D_Scan =====> Analog Scan = 0 , Digital Scan = 1 >>>>> in this example 0 for analog scanning
...
Adv_Line_Follower my_Car(0,0,6,5,75);
void setup() {
}
void loop() {
   my_Car.go();
